...
contract DeployPriceFeeds is Script {
    function run() external {
        ...
        address ethTokenAddress = address(0xa91feCD327AA6C2ffCC6256005E0aA0a7f71FeDc);
        ...
        MockPriceFeeds priceFeeds = new MockPriceFeeds(ethTokenAddress, ethPriceFeedAddress);

        // add btc price feed
        // Output the address of the deployed contract
        console.log("MockPriceFeeds deployed to:", address(priceFeeds));
