...
contract EquitySwapTest is Test {
    ...
    function setUp() public virtual {
        ...
        btcPriceFeedAddress = mockPriceFeed(2,60000e6,"BTC/USDC");//btc
        ...
        usdcContractAddress.mint(swaper,10000e6);
        usdcContractAddress.mint(pairer,10000e6);
    }
    ...
    function test_openSwap() external  {
        ...
        uint256 swaperUsdcAmount = 10000e6;
    ...
    function test_pairSwap() external  {
        ...
        uint256 pairUsdcAmount = 600000e6;
    ...
    function test_settlePairerWin() external {
        ...
        uint64 originalLegId = 1;
        uint256 pairUsdcAmount = 6*10000e6; 
        vm.startPrank(address(0x7FA9385bE102ac3EAc297483Dd6233D62b3e1496));
        usdcContractAddress.mint(pairer, pairUsdcAmount);
        vm.stopPrank();
    ...
    function mockPriceFeed(uint tokenType,uint price,string memory description) internal returns(address priceFeed) {
        // mock price
        uint8  DECIMALS = 6;
    ...
    function showLegInfo(EquitySwap.Leg memory result) internal {
